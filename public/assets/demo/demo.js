...
// client_lat client_lng client_loc user_lat user_lng user_name
     
    var user = new google.maps.LatLng(user_lat, user_lng);
    var client = new google.maps.LatLng(client_lat, client_lng);
  ...
  register: function() {
    ...
    const trackLocation = ({ onSuccess, onError = () => { } }) => {
      ...
      onError: err => {
        // Print out the error message.
        var lat = `Error: ${getPositionErrorMessage(err.code) || err.message}`;
        var lng = `Error: ${getPositionErrorMessage(err.code) || err.message}`;
